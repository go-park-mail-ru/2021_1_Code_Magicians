...
type WebsocketInfo struct {
	...
	chatApp         delivery.ChatAppInterface
	websocketApp    delivery.WebsocketAppInterface
	csrfOn          bool
	logger          *zap.Logger
}

func NewWebsocketInfo(notificationApp delivery.NotificationAppInterface, chatApp delivery.ChatAppInterface,
	websocketApp delivery.WebsocketAppInterface,
