...
func NewProfileInfo(userApp delivery.UserAppInterface, authApp delivery.AuthAppInterface,
	s3App delivery.S3AppInterface, notificationApp delivery.NotificationAppInterface,
...
func (profileInfo *ProfileInfo) HandleGetProfile(w http.ResponseWriter, r *http.Request) {
	...
	if !found {
		...
		w.Header().Add("Content-Type", "delivery/json")
