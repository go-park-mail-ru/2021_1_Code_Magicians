...
type WebsocketInfo struct {
	...
	chatApp         usecase.ChatAppInterface
	websocketApp    usecase.WebsocketAppInterface
	csrfOn          bool
	logger          *zap.Logger
}

func NewWebsocketInfo(notificationApp usecase.NotificationAppInterface, chatApp usecase.ChatAppInterface,
	websocketApp usecase.WebsocketAppInterface,
