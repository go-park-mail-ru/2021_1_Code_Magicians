...
var file_user_proto_rawDesc = []byte{
	...
	0x22, 0x07, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x9e, 0x05, 0x0a, 0x04, 0x55, 0x73,
	...
	0x4c, 0x69, 0x73, 0x74, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x00, 0x12, 0x2b, 0x0a, 0x0a,
	0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x0e, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x1a, 0x0b, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x00, 0x12, 0x2f, 0x0a, 0x0e, 0x43, 0x68, 0x61,
	...
	0x65, 0x72, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x00, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f,
...
var file_user_proto_depIdxs = []int32{
	...
	5,  // 3: user.User.DeleteUser:input_type -> user.UserID
	5,  // 4: user.User.GetUser:input_type -> user.UserID
	6,  // 5: user.User.GetUserByUsername:input_type -> user.Username
	15, // 6: user.User.GetUsers:input_type -> google.protobuf.Empty
	7,  // 7: user.User.UpdateAvatar:input_type -> user.UploadAvatar
	10, // 8: user.User.Follow:input_type -> user.Follows
	10, // 9: user.User.Unfollow:input_type -> user.Follows
	10, // 10: user.User.CheckIfFollowed:input_type -> user.Follows
	13, // 11: user.User.SearchUsers:input_type -> user.SearchInput
	9,  // 12: user.User.DeleteFile:input_type -> user.FilePath
	12, // 13: user.User.ChangePassword:input_type -> user.Password
	5,  // 14: user.User.CreateUser:output_type -> user.UserID
	14, // 15: user.User.SaveUser:output_type -> user.Error
	14, // 16: user.User.DeleteUser:output_type -> user.Error
	3,  // 17: user.User.GetUser:output_type -> user.UserOutput
	3,  // 18: user.User.GetUserByUsername:output_type -> user.UserOutput
	4,  // 19: user.User.GetUsers:output_type -> user.UsersListOutput
	8,  // 20: user.User.UpdateAvatar:output_type -> user.UploadAvatarResponse
	14, // 21: user.User.Follow:output_type -> user.Error
	14, // 22: user.User.Unfollow:output_type -> user.Error
	11, // 23: user.User.CheckIfFollowed:output_type -> user.IfFollowedResponse
	4,  // 24: user.User.SearchUsers:output_type -> user.UsersListOutput
	14, // 25: user.User.DeleteFile:output_type -> user.Error
	14, // 26: user.User.ChangePassword:output_type -> user.Error
